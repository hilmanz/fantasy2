        ...
        <div id="content">
        	<div class="content">
                ...
                <form class="theForm">
                    ...
                    <div class="row-2">
                        <div class="col2 player-list">
                            <div class="jersey-player ">
                                <div class="jersey j-red">8</div>
                            ...
                            <div class="jersey-player ">
                                <div class="jersey j-grey">5</div>
                                <span class="player-name">Ashley</span>
                            </div><!-- end .jersey-player -->
                            <div class="jersey-player ">
                                <div class="jersey j-grey">6</div>
                                <span class="player-name">Smalling</span>
                            </div><!-- end .jersey-player -->
                            <div class="jersey-player ">
                                <div class="jersey j-grey">3</div>
                            ...
                            <div class="jersey-player ">
                                <div class="jersey j-red">23</div>
                                <span class="player-name">Messi</span>
                            </div><!-- end .jersey-player -->
                            <div class="jersey-player ">
                                <div class="jersey j-red">14</div>
