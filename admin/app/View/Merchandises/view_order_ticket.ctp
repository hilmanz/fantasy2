...
$merchandise_order_json = $rs['MerchandiseOrder']['data'][0]['data']['MerchandiseItem']['data'];
$merchandise_order_data = json_decode($merchandise_order_json, true);
	...
	<div class="row">
		<table width="100%" class="table">
			...
			<tr>
				...
				<td>
					<?php
						foreach ($merchandise_order_data as $key => $value) {
