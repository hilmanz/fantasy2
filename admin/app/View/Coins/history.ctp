<h3>
	Coins Redeemed History
</h3>
<div>
	<a href="<?=$this->Html->url('/coins/add')?>" class="button">Add Coins</a>
</div>
<div class="theContainer">
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0" class="dataTable">
		...
		<tr>
			...
			<td>
				<?=h($m['AddCoinHistory']['name'])?>
			</td>
			<td>
				<?=h($m['AddCoinHistory']['amount'])?>
			</td>
			<td>
				<?=h($m['AddCoinHistory']['post_dt'])?>
			</td>
			<td>
				<a href="<?=$this->Html->url('/coins/history/').$m['AddCoinHistory']['id']?>" class="button">View</a>
			</td>
		</tr>
		<?php endforeach;?>
	</table>
